...
function* authUser(action) {
  const url = action.mode === "SIGN_IN" ? "/api/v1/signin" : "/api/v1/signup";
  try {
...
function* makeReservation(action) {
  try {
    ...
    const message =
      "Pomyślnie zarezerwowano miejsca. Bilety wkrótce zostaną przesłane na email powiązany z kontem";
